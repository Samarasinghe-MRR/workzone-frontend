...
const mockJobs: Job[] = [
  {
    ...
    description:
      "Need electrical work for new office space. Installation of outlets, lighting fixtures, and circuit breaker updates.",
  ...
  },
  {
    ...
    description:
      "Lawn mowing, hedge trimming, and general garden cleanup for medium-sized property.",
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-gray-600 mt-2">
                  Posted by {selectedJob.customerName}
                </p>
              </div>
