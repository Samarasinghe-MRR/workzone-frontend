  ...
  useEffect(() => {
    if (profile) {
      setProfileForm({
        ...
        email: profile.email || "",
        phone: profile.phone || "",
        businessName: profile.businessName || profile.name || "", // Use businessName if available, fallback to name
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      const success = await updateProfile({
        ...
        location: profileForm.businessAddress, // Map businessAddress to location for backend compatibility
      });
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Provider since August 2020</p>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-sm text-blue-800 mb-3">
              Payments are processed weekly on Fridays. It may take 1-3 business
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <br />
                <span className="text-blue-700">Friday, Aug 30</span>
              </div>
              <div>
                <span className="font-medium">Estimated Amount:</span>
                <br />
                <span className="text-blue-700">$270.00</span>
              </div>
            </div>
          </div>
        </CardContent>
              ...
              <div className="flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    className="sr-only peer"
                    checked={notifications.quotationResponses}
                    onChange={(e) =>
                      setNotifications((prev) => ({
                        ...prev,
                        quotationResponses: e.target.checked,
                      }))
                    }
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-emerald-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600"></div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <select className="px-3 py-2 border border-gray-300 rounded-md">
                ...
                <option>Verified Customers</option>
              </select>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Hide contact details until job is accepted
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-medium">Show Exact Location</h4>
                <p className="text-sm text-gray-600">
                  Show precise address vs general area
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mb-3">
                Temporarily deactivate your provider account. You can reactivate
                it anytime.
              </p>
              <Button
                variant="outline"
